...
knitr::include_graphics("pics/team/brooklynn.jpg")
```
...
```{r, echo=FALSE, fig.width = 10}
knitr::include_graphics("pics/team/dylan.jpg")
```
...
```{r, echo=FALSE, fig.width = 10}
knitr::include_graphics("pics/team/tamara.jpg")
```
...
```{r, echo=FALSE, fig.width = 10}
knitr::include_graphics("pics/team/wayne.jpg")
```
