...
raw_weather <- read_csv("raw_data/raw_weather_data.csv")
...
```{r snowfall and snow depth, message = FALSE}
### snowfall ###
...
```{r snowfall vs dist, message = FALSE}
...
```{r snow depth vs dist, message = FALSE}
...
```{r avg temp vs dist, warning = FALSE}
