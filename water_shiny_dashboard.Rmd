...
```{r}
elk = read.csv(file = "./water_analysis_files/data2/elk.csv") |> 
  mutate(date = as.Date(paste(year, month, day, sep = "-")))

water_quality = read.csv(file = "./water_analysis_files/data2/water_quality.csv") |> 
  mutate(date = as.Date(paste(year, month, day, sep = "-"))) |> 
...
```{r}
elk_icon = makeIcon(
  iconUrl = "data2/elk_icon.png", 
  iconWidth = 30, 
  iconHeight = 30)

water_icon = makeIcon(
  iconUrl = "data2/water_droplet.png",
  iconWidth = 30,
  iconHeight = 30)
```
